...
- (void)viewDidLoad {
    ...
    _screenshotImgView.frame = CGRectMake(0, 0, KLScreenWidth, KLScreenHeight);
...
- (void)screenShot
{
    ...
    // 要裁剪的矩形范围
    CGRect rect = CGRectMake(0, 0, KLScreenWidth, KLScreenHeight);
...
- (void)dragBegin
{
    ...
    //_screenshotImgView.transform = CGAffineTransformMakeTranslation(KLScreenWidth, 0);
}
...
- (void)dragging:(UIPanGestureRecognizer *)pan
{
    ...
    if (offsetX < KLScreenWidth) {
        
        _screenshotImgView.transform = CGAffineTransformMakeTranslation((offsetX - KLScreenWidth) * 0.6, 0);
    }
...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UIImageView * screentImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, KLScreenWidth, KLScreenHeight)];
    ...
    fromViewEndFrame.origin.x = KLScreenWidth;
    ...
    if (self.navigationOperation == UINavigationControllerOperationPush) {
        ...
        UIView * nextVC = [[UIView alloc]initWithFrame:CGRectMake(KLScreenWidth, 0, KLScreenWidth, KLScreenHeight)];
        ...
        self.navigationController.view.transform = CGAffineTransformMakeTranslation(KLScreenWidth, 0);
        
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
            //toView.frame = toViewEndFrame;
            self.navigationController.view.transform = CGAffineTransformMakeTranslation(0, 0);
            screentImgView.center = CGPointMake(-KLScreenWidth/2, KLScreenHeight / 2);
            //nextVC.center = CGPointMake(KLScreenWidth/2, KLScreenHeight / 2);
    ...
    if (self.navigationOperation == UINavigationControllerOperationPop) {
        ...
        UIImageView * lastVcImgView = [[UIImageView alloc]initWithFrame:CGRectMake(-KLScreenWidth, 0, KLScreenWidth, KLScreenHeight)];
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
            ...
            screentImgView.center = CGPointMake(KLScreenWidth * 3 / 2 , KLScreenHeight / 2);
            lastVcImgView.center = CGPointMake(KLScreenWidth/2, KLScreenHeight/2);
