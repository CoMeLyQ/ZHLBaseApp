...
@implementation UIImageView (QTool)
...
-(void)sd_imageUrlStr:(NSString *)str{
    ...
    [self sd_setImageWithURL:[NSURL URLWithString:str] placeholderImage:[UIImage imageNamed:@"未加载_小"]];
...
-(void)sd_imageUrlStr:(NSString *)str placeholderImagename:(NSString *)imagename{
    ...
    [self sd_setImageWithURL:[NSURL URLWithString:str] placeholderImage:[UIImage imageNamed:imagename]];
